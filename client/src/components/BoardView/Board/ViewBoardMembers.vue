...
async function fetchBoardMembers() {
  try {
    ...
    boardMembers.value = members.filter((m): m is BoardMember => m !== null)
...
<template>
  ...
  >
    <div class="relative z-[1001] w-96 rounded-lg bg-white p-6 shadow-lg">
      ...
      <div v-if="notAuthorized" class="mb-4">
        <p class="text-sm text-red-500">You are not authorized to view this board’s members.</p>
      </div>
      <div v-else>
